...
@Disabled
public class BLUE_AutonomousProgramLeaguePlay_V2 extends OpMode {
    ...
    double[][] movementArray = new double[][]{
            //_,______,______}
            {1,   0.1,     8}, //Move forwards
            {1, 0.075,     1}, //Creep forwards and prepare to shoot
            {11,    0,     0}, //Shoot
